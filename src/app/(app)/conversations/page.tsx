...
import { Mail, MessageCircle, PhoneCall, Smartphone, Search, Globe } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="grid gap-4 lg:grid-cols-[360px_1fr]">
        ...
        <Card className="flex max-h-[75vh] min-h-[480px] flex-col">
          {active ? (
            <>
              <div className="flex items-center gap-3 border-b border-border p-4">
                ...
                {active.call ? <Link href={`/calls/${active.call.id}`} className="text-xs text-[#a3a3ff] hover:underline">Open call details</Link> : null}
              </div>
              <div className="flex-1 overflow-y-auto p-4">
                {active.call ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-start"><div className="max-w-[70%] rounded-2xl rounded-tl-sm bg-surface-2 px-3.5 py-2 text-sm">{active.preview}</div></div>
