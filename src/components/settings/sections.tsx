...
export function NotificationsSection() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="grid grid-cols-[1fr_repeat(4,44px)] items-center gap-1 border-b border-border pb-2 text-[10px] font-semibold uppercase tracking-wider text-muted sm:grid-cols-[1fr_repeat(4,64px)] sm:gap-2 sm:text-[11px]"><span>Event</span><span className="text-center">In-app</span><span className="text-center">Email</span><span className="text-center">Push</span><span className="text-center">Slack</span></div>
        {items.map((it, i) => <div key={it} className="grid grid-cols-[1fr_repeat(4,44px)] items-center gap-1 border-b border-border py-2.5 text-sm sm:grid-cols-[1fr_repeat(4,64px)] sm:gap-2"><span>{it}</span><span className="flex justify-center"><Switch defaultChecked /></span><span className="flex justify-center"><Switch defaultChecked={i < 3 || i > 5} /></span><span className="flex justify-center"><Switch defaultChecked={i === 0 || i === 2} /></span><span className="flex justify-center"><Switch defaultChecked={i < 2} /></span></div>)}
